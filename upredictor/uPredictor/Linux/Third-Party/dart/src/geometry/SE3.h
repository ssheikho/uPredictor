...
struct SE3 {
	...
	void setVals(float x, float y, float z) {
        r0 = make_float4(1,0,0,x);
        r1 = make_float4(0,1,0,y);
        r2 = make_float4(0,0,1,z);
	}
};
...
struct se3 {
	...
	inline PREFIX void setVals(const float x, const float y, const float z, const float wx, const float wy, const float wz) {
