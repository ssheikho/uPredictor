...
#ifdef CUDA_BUILD
    const DepthType * getDepth() { return _depthData->hostPtr(); }
    const DepthType * getDeviceDepth() { return _depthData->devicePtr(); }
#else
    const DepthType * getDepth() { return _depthData; }
    const DepthType * getDeviceDepth() { return 0; }
#endif // CUDA_BUILD

    const ColorType * getColor() { return _colorData; }
