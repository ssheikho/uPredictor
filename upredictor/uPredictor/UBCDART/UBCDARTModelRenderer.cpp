...
UBCDARTModelRenderer::UBCDARTModelRenderer(MeshReader * meshReader) {
	//glPushMatrix();
...
void UBCDARTModelRenderer::renderMesh(const uint meshNum) const {
...
const Mesh &UBCDARTModelRenderer::getMesh(const uint meshNum) const {
