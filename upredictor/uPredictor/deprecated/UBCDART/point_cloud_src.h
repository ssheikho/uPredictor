...
public:
    ...
    virtual unsigned int getDepthWidth() const { return _depthSource->getDepthWidth(); }
    virtual unsigned int getDepthHeight() const { return _depthSource->getDepthHeight(); }
    inline unsigned int getColorWidth() const { return _depthSource->getColorWidth(); }
    inline unsigned int getColorHeight() const { return _depthSource->getColorHeight(); }
    inline unsigned int getFrame() const { return _depthSource->getFrame(); }
    inline void setFrame(const unsigned int frame) { _depthSource->setFrame(frame); }
