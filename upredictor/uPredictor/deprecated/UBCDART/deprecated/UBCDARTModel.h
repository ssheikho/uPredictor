#ifndef UBC_DART_MODEL_H
#define UBC_DART_MODEL_H
...
namespace dart {
	...
	public:
		...
		UBCDARTModel(UBCDARTModelRenderer *renderer
			, const int dimensionality) : _renderer(renderer)
			, _dimensionality(dimensionality) {}

		UBCDARTModel(UBCDARTModelRenderer *renderer
			, const UBCDARTModel &copy);
	...
	private:
		...
		void renderGeometries(void (UBCDARTModel::*prerenderFunc)(const int, const int, const char *) const,
			const char * args = 0,
			void (UBCDARTModel::*postrenderFunc)() const = 0) const;
		...
		void renderFrames(void (UBCDARTModel::*renderFrameFunc)(const int, const char*) const,
