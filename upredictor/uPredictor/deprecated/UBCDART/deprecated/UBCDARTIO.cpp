...
namespace dart {
	...
	void readFrameXML(const int parent, UBCDARTHostOnlyModel & model, TiXmlElement * element, std::string & dir, const int version) {
	...
	void writeGeomXML(const UBCDARTHostOnlyModel & model, const int geom, TiXmlElement * parent) {
	...
	void writeFrameXML(const UBCDARTHostOnlyModel & model, const int frame, TiXmlElement * parent) {
