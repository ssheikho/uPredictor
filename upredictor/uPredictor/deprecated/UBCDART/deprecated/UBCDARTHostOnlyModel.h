#ifndef UBC_DART_HOST_ONLY_MODEL_H
#define UBC_DART_HOST_ONLY_MODEL_H
...
namespace dart {
	...
	class UBCDARTHostOnlyModel : public UBCDARTModel {
	public:
		UBCDARTHostOnlyModel(UBCDARTModelRenderer *renderer);
		~UBCDARTHostOnlyModel();
