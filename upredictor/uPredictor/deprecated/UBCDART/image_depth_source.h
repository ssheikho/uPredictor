...
public:
    ...
    */
    bool initialize(const std::string depthFilenameFormat,
                    ...
                    const unsigned int depthWidth = 0,
                    const unsigned int depthHeight = 0,
                    const unsigned int firstDepthFrame = 0,
                    const bool hasColor = false,
                    const std::string colorFilenameFormat = "",
                    const unsigned int colorWidth = 0,
                    const unsigned int colorHeight = 0,
                    const unsigned int firstColorFrame = 0 );
    ...
    */
    bool initialize(const std::string & depthDirectory,
                    ...
                    const std::vector<unsigned long> * depthTimes = 0,
                    const bool hasColor = false,
...
private:
    ...
    unsigned int _firstDepthFrame;
    unsigned int _lastDepthFrame;
    unsigned int _firstColorFrame;
    unsigned int _lastColorFrame;
    ...
    std::vector<unsigned long> _depthTimes;
    std::vector<unsigned long> _colorTimes;
    std::vector<unsigned int> _correspondingColorFrames;
...
bool ImageDepthSource<DepthType,ColorType>::initialize( const std::string & depthDirectory,
                                                        ...
                                                        const unsigned int depthWidth,
                                                        const unsigned int depthHeight,
                                                        const float scaleToMeters,
                                                        const std::vector<unsigned long> * depthTimes,
                                                        const bool hasColor,
                                                        const std::string colorDirectory,
                                                        const ImageType colorImageType,
                                                        const unsigned int colorWidth,
                                                        const unsigned int colorHeight,
...
bool ImageDepthSource<DepthType,ColorType>::initialize(const std::string depthFilenameFormat,
                                                       ...
                                                       const unsigned int depthWidth,
                                                       const unsigned int depthHeight,
                                                       const unsigned int firstDepthFrame,
                                                       const bool hasColor,
                                                       const std::string colorFilenameFormat,
                                                       const unsigned int colorWidth,
                                                       const unsigned int colorHeight,
                                                       const unsigned int firstColorFrame) {
...
template <typename DepthType, typename ColorType>
void ImageDepthSource<DepthType,ColorType>::setFrame(const unsigned int frame) {
...
bool ImageDepthSource<DepthType, ColorType>::getDimPNG(const char * filename,
    ...
    width = (unsigned int)widthLong;
    height = (unsigned int)heightLong;
