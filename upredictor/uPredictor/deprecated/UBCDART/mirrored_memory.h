...
public:
     ...
     */
    MirroredVector(const unsigned int length);
...
template <typename T>
MirroredVector<T>::MirroredVector(const unsigned int length) : _length(length) {
    if(length != 0){
...
template <typename T>
void MirroredVector<T>::resize(const unsigned int length) {
    T * hTmp = _hVector;
    T * dTmp = _dVector;
    if(length != 0){
        // host
...
public:
     ...
     */
    MirroredGrid3DVector(const unsigned int length, const Grid3D<T> * grids);
...
template <typename T>
MirroredGrid3DVector<T>::MirroredGrid3DVector(const unsigned int length, const Grid3D<T> * grids) : _length(length) {
